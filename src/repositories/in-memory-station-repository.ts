...
export class InMemoryStationRepository {
    ...
    public getStationsForRoute(routeName): TrainStation[] {
        if (routeName === "blue") {
            return this.blueLineStations
        } else if (routeName === "brn") {
            return this.brownLineStations
        }
    }
}